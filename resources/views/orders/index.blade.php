    ...
    <div class="container-fluid">
        ...
        <style>
            ...
            .radio-item input[type="radio"]:after {
                ...
                height: 12px;
                border-radius: 10px;
                background: radial-gradient(ellipse at top left, rgb(240, 255, 220) 0%, rgb(3, 176, 21) 5%, rgb(17, 221, 27) 95%, rgb(60, 201, 12) 100%, );
                content: '';
                cursor: pointer;
            }
    ...
    @section('script')
        <script>
            ...
            function PrintReceiptContent(el) {
                var data =
                    '<input type ="button" id ="PrintPageButton" class="PrintPageButton" style="display:block; width: 100%; border: none; background-color: #008B8B; color: #fff; padding: 14px 28px; font-size: 16px; cusor: pointer; text-align: center value= "Print Receipt" onclick="window.print()">';
