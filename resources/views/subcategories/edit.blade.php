        ...
        <div class="modal-dialog right-crud modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="title">Edit A Catalogue</h3>
                    <button class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <form wire:submit.prevent="update({{ $section->id }})" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary btn-block">Update Your Catalogue</button>
