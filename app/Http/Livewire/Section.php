...
// remove more
    ...
    public function store(Request $request){
        ...
        $this->FormReset();
        $this->SwalMessageDialog('Add a success category');
    ...
    public function update($section_id){
        ...
        $this->FormReset();
        $this->SwalMessageDialog('Successful Catalog Update');
    ...
    public function confirmBulkDelete(){
        $this->dispatchBrowserEvent('Swal:DeletedRecord', [
            'title' => "Are you sure you want to delete all categories?",
            'id' => $this->checked
        ]);
    }
    ...
    public function ConfirmDelete($section_id, $section_name){
        $this->dispatchBrowserEvent('Swal:DeletedRecord', [
            'title' => "Are you sure you want to delete a category <span class='text-danger'> $section_name</span> ?",
            'id' => $section_id
        ]);
    }
